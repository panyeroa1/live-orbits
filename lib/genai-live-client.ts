...
export class GenAILiveClient {
  ...
  public on<K extends keyof LiveClientEventTypes>(event: K, listener: LiveClientEventTypes[K]) {
    this.emitter.on(event, listener as any);
    return this;
  }
  
  public off<K extends keyof LiveClientEventTypes>(event: K, listener: LiveClientEventTypes[K]) {
    this.emitter.off(event, listener as any);
    return this;
  }
  
  public emit<K extends keyof LiveClientEventTypes>(event: K, ...args: Parameters<LiveClientEventTypes[K]>) {
